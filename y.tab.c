...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_WRITELINE = 18,                 /* WRITELINE  */
  ...
  YYSYMBOL_FunctionBlock = 48,             /* FunctionBlock  */
  YYSYMBOL_IdentifierList = 49,            /* IdentifierList  */
  YYSYMBOL_Block = 50,                     /* Block  */
  YYSYMBOL_ConstDecl = 51,                 /* ConstDecl  */
  YYSYMBOL_ConstAssignmentList = 52,       /* ConstAssignmentList  */
  YYSYMBOL_VarDecl = 53,                   /* VarDecl  */
  YYSYMBOL_ArrDecl = 54,                   /* ArrDecl  */
  YYSYMBOL_ArrList = 55,                   /* ArrList  */
  ...
  YYSYMBOL_ExpressionList = 65             /* ExpressionList  */
};
...
{
  "\"end of file\"", "error", "\"invalid token\"", "FUNCTION", "DO",
  "CONST", "VAR", "ARR", "PROCEDURE", "IF", "THEN", "ELSE", "WHILE", "FOR",
  "BREAK", "RETURN", "READ", "WRITE", "WRITELINE", "BEGIN_", "END", "ODD",
  "CALL", "TO", "IDENTIFIER", "NUMBER", "NE", "LE", "GE", "'+'", "'-'",
  "'*'", "'/'", "'%'", "'='", "'<'", "'>'", "'.'", "'('", "')'", "','",
  "';'", "'['", "']'", "'!'", "$accept", "Program", "FunctionList",
  "FunctionBlock", "IdentifierList", "Block", "ConstDecl",
  "ConstAssignmentList", "VarDecl", "ArrDecl", "ArrList", "Array",
  "ProcDecl", "Statement", "StatementList", "Condition", "Expression",
  "Term", "Factor", "FuncCall", "ExpressionList", YY_NULLPTR
};
